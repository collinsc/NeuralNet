...
h1 = 200;     %neurons in hidden layer 1
h2 = 20;      %neurons in hidden layer 2
[W1,b1,W2,b2,W3,b3] = getWeights(P_o,T_o, h1, h2);
cW1 = W1; cb1 = b1; cW2 = W2; cb2 = b2; cW3 = W3; cb3 = b3;
vW1 = W1; vb1 = b1; vW2 = W2; vb2 = b2; vW3 = W3; vb3 = b3;
disp('Training:')
count = 0;
for batch = 1:batchSize:size(P_o,2)   %for each mini batch
    ...
    [cW1,cb1,cW2,cb2,cW3,cb3] = conjugateTrain( P1, T1, ...
                                                cW1, cb1, ...
                                                cW2, cb2, ...
                                                cW3, cb3, ...
                                                epochs, false);

    [vW1,vb1,vW2,vb2,vW3,vb3] = vanillaTrain(   P1, T1, ...
                                                vW1, vb1, ...
                                                vW2, vb2, ...
                                                vW3, vb3, ...
                                                epochs, false);
    %test our modifications
    evaluate1 = @(x) evaluate(cW1,cb1,cW2,cb2,cW3,cb3, x);
    err1 = getPercError(evaluate1,P1,T1);
    evaluate2 = @(x)  evaluate(vW1,vb1,vW2,vb2,vW3,vb3, x);
