function [W1,b1,W2,b2,W3,b3] = vanillaTrain(P,T,W1,b1,W2,b2,W3,b3, batchCount,isPlot)
Q = size(P,2);
...
for i = 1:batchCount
    for j = 1:Q
        [ gW1, gb1, gW2, gb2, gW3, gb3 ] = getGradients(W1, b1, ...
                                                        W2, b2, ... 
                                                        W3, b3, ...
                                                        P(:,j),T(:,j) );
        W1 = W1 - rate*gW1;    b1 = b1 - rate*gb1;
        W2 = W2 - rate*gW2;    b2 = b2 - rate*gb2;
        W3 = W3 - rate*gW3;    b3 = b3 - rate*gb3;
    end
        if isPlot
        outIdx = outIdx +1;
